    ...
    <div>
      ...
      <Page className="bg-gray-100">
        ...
        <div className="mb-12">
          ...
          <h3 className="font-bold text-lg mt-6 mb-0">Representation</h3>
          <p>Katia Yakovleva, Riccardo Buzzotta and Daniel Baumann</p>

          <h3 className="font-bold text-lg mt-6 mb-0">
        ...
        <div className="mb-12">
          <h2 className="font-bold text-xl mb-4">
            2. Purposes to process your personal data
          </h2>
          ...
          <p className="mb-4">
            To revoke the consent, please contact us katia@marmelade.ai
          </p>

          <h3 className="font-bold text-lg mt-6 mb-0">Legal Prosecution</h3>
          <p className="mb-4">
        ...
        <div className="mb-12">
          <h2 className="font-bold text-xl mb-4">
            3. To which recipients will personal data be transmitted?
          </h2>
          <p className="mb-4">
        ...
        <div className="mb-12">
          <h2 className="font-bold text-xl mb-4">4. Profiling</h2>
          <p className="mb-4">
        ...
        <div className="mb-12">
          <h2 className="font-bold text-xl mb-4">6. Rights</h2>
          <p className="mb-4">
        ...
        <div className="mb-12">
          <h2 className="font-bold text-xl mb-4">7. Cookie Information</h2>
          <h3 className="font-bold text-lg mt-6 mb-0">What are cookies?</h3>
          <p className="mb-4">
            ...
            of the browser program. The website uses "cookies" essentially to
            recognize users or their devices, to save the user's preferences or
            information for the duration of the surfing or in the event of
            return. Cookies are also used to display behavior-based advertising
            and to control ad content.
          </p>

          <h3 className="font-bold text-lg mt-6 mb-0">
            What types of cookies are there?
          </h3>
          <p className="mb-4">a. Distinction by domain</p>
          <p className="mb-4">
          ...
          <h3 className="font-bold text-lg mt-6 mb-0">
            Distinction according to storage duration
          </h3>
          <p className="mb-4">
            Session cookies (session-id): Temporary cookies that are
            automatically deleted when the browser is closed. Session cookies
            enable the user's movements on the website to be recognized, so that
            information is retained. Without cookies, websites have no "memory".
          </p>
          <p className="mb-4">
