      ...
      <Page className="bg-gray-100">
        ...
        <ContentBlock>
          ...
          <P>
            ...
            recognize users or their devices, to save the user&apos;s
            preferences or information for the duration of the surfing or in the
            event of return. Cookies are also used to display behavior-based
            advertising and to control ad content.
          </P>
